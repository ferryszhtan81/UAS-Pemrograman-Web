                ...
                <tbody>
                    ...
                    <?php foreach ($data as $data) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="../ui/FormEditKatalog.php?id=" id="edit"><button type="button" class="editbutton">Edit</button></a>
                                <a href="../ui/HapusKatalog.php?id=" onclick="return confirm('Yakin Hapus?')"><button type="button" class="hapusbutton">Hapus</button></a>
                            </td>
                        </tr>
